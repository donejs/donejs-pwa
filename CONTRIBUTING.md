# Contributing to donejs-pwa

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/donejs/donejs-pwa) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork donejs-pwa, you can start by going to its [fork page](https://github.com/donejs/donejs-pwa/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/donejs-pwa
```
